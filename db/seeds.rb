...
r1=Rating.create!(rating:6.4 , review:'This D. W. Grifith movie was interesting for the many suspenseful moments', movie_id: m1.id, user_id: u1.id )
r2=Rating.create!(rating:6.4 , review:'This D. W. Grifith movie was interesting for the many suspenseful moments', movie_id: m1.id, user_id: u1.id )
